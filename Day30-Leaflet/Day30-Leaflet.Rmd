...
Let's get started with adding this layer by calling our basemap of NYC, piping the `addCircleMarkers()` function and setting the following three arguments in the `addCircleMarkers()` function.  
