...
## Exercise 4: Condense the following lines of code into one code snippet in order to create a reproducible example of the code. Paste the reproducible example into the forum that I created at the bottom of our Moodle page. 
